...
2. **Missing target email**: If the person in Outreach has no email in the People DB, flag it. Cannot create a draft without a recipient email. Do not backfill the People page's Email from the thread or ContactOut — report it and let Tom decide.
