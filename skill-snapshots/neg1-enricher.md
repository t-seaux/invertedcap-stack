...
description: >-
  ...
  a candidate card to #neg1-sourcing for EVERY candidate regardless of verdict (Reach Out / Second Look / Pass) —
  one individual alert per candidate, never a consolidated batch notification. NOTHING lands in Notion — that happens only
